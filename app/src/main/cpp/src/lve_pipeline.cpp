...
LvePipeline::LvePipeline(
    ...
    : lveDevice{device} {
  createGraphicsPipeline(am, vertFilepath, fragFilepath, configInfo);
}
...
std::vector<char> LvePipeline::readFile(AAssetManager *am, const std::string& filepath) {
    ...
    AAsset* asset = AAssetManager_open(am, filepath.c_str(), AASSET_MODE_BUFFER);
...
void LvePipeline::createGraphicsPipeline(
  ...
  auto vertCode = readFile(am, vertFilepath);
  auto fragCode = readFile(am, fragFilepath);
